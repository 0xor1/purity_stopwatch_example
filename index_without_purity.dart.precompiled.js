...
function dart_precompiled($collectedClasses) {
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Base.prototype = $desc;
  Base.prototype.get$html = function(receiver) {
    return this.html;
  };
  function Base_addClasses_closure(this_0) {
    this.this_0 = this_0;
  }
  Base_addClasses_closure.builtin$cls = "Base_addClasses_closure";
  if (!"name" in Base_addClasses_closure)
    Base_addClasses_closure.name = "Base_addClasses_closure";
  $desc = $collectedClasses.Base_addClasses_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Base_addClasses_closure.prototype = $desc;
  function Control() {
  }
  ...
  function Control_closure(this_0) {
    this.this_0 = this_0;
  }
  Control_closure.builtin$cls = "Control_closure";
  if (!"name" in Control_closure)
    Control_closure.name = "Control_closure";
  $desc = $collectedClasses.Control_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Control_closure.prototype = $desc;
  function Control_closure0(this_1) {
    this.this_1 = this_1;
  }
  Control_closure0.builtin$cls = "Control_closure0";
  if (!"name" in Control_closure0)
    Control_closure0.name = "Control_closure0";
  $desc = $collectedClasses.Control_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Control_closure0.prototype = $desc;
  function Button(_content, _id, _blurController, _focusController, html) {
    this._content = _content;
    this._id = _id;
    this._blurController = _blurController;
  ...
  function Label(_id, _blurController, _focusController, html) {
    this._id = _id;
    this._blurController = _blurController;
    this._focusController = _focusController;
    this.html = html;
  ...
  EnumValue.builtin$cls = "EnumValue";
  if (!"name" in EnumValue)
    EnumValue.name = "EnumValue";
  $desc = $collectedClasses.EnumValue;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EnumValue.prototype = $desc;
  EnumValue.prototype.get$value = function(receiver) {
    return this.value;
  };
  function HAlign(value) {
    this.value = value;
  }
  HAlign.builtin$cls = "HAlign";
  if (!"name" in HAlign)
    HAlign.name = "HAlign";
  $desc = $collectedClasses.HAlign;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HAlign.prototype = $desc;
  function Orientation(value) {
    this.value = value;
  }
  Orientation.builtin$cls = "Orientation";
  if (!"name" in Orientation)
    Orientation.name = "Orientation";
  $desc = $collectedClasses.Orientation;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Orientation.prototype = $desc;
  function Panel() {
  }
  ...
  function AlignPanel(_outerLayoutAssistant, _innerLayoutAssistant, _horizontal, _vertical, items, html) {
    this._outerLayoutAssistant = _outerLayoutAssistant;
    this._innerLayoutAssistant = _innerLayoutAssistant;
    this._horizontal = _horizontal;
    this._vertical = _vertical;
    this.items = items;
    this.html = html;
  }
  AlignPanel.builtin$cls = "AlignPanel";
  if (!"name" in AlignPanel)
    AlignPanel.name = "AlignPanel";
  $desc = $collectedClasses.AlignPanel;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AlignPanel.prototype = $desc;
  function StackPanel(_orientation, items, html) {
    this._orientation = _orientation;
    this.items = items;
    this.html = html;
  }
  StackPanel.builtin$cls = "StackPanel";
  if (!"name" in StackPanel)
    StackPanel.name = "StackPanel";
  $desc = $collectedClasses.StackPanel;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StackPanel.prototype = $desc;
  function StackPanel_closure() {
  }
  StackPanel_closure.builtin$cls = "StackPanel_closure";
  if (!"name" in StackPanel_closure)
    StackPanel_closure.name = "StackPanel_closure";
  $desc = $collectedClasses.StackPanel_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StackPanel_closure.prototype = $desc;
  function Style(_hasBeenInserted, text) {
    this._hasBeenInserted = _hasBeenInserted;
    this.text = text;
  }
  ...
  VAlign.builtin$cls = "VAlign";
  if (!"name" in VAlign)
    VAlign.name = "VAlign";
  $desc = $collectedClasses.VAlign;
  if ($desc instanceof Array)
    $desc = $desc[1];
  VAlign.prototype = $desc;
  ...
  EventDetector.prototype.get$_typeIndexes = function() {
    return this.eventable$EventDetector$_typeIndexes;
  };
  EventDetector.prototype.get$_typeIndexes.$reflectable = 1;
  EventDetector.prototype.set$_typeIndexes = function(v) {
    return this.eventable$EventDetector$_typeIndexes = v;
  };
  EventDetector.prototype.set$_typeIndexes.$reflectable = 1;
  EventDetector.prototype.get$_emitterIndexes = function() {
    return this.eventable$EventDetector$_emitterIndexes;
  };
  EventDetector.prototype.get$_emitterIndexes.$reflectable = 1;
  EventDetector.prototype.set$_emitterIndexes = function(v) {
    return this.eventable$EventDetector$_emitterIndexes = v;
  };
  ...
  function EndPointMessage(_internal) {
    this._internal = _internal;
  }
  EndPointMessage.builtin$cls = "EndPointMessage";
  if (!"name" in EndPointMessage)
    EndPointMessage.name = "EndPointMessage";
  $desc = $collectedClasses.EndPointMessage;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EndPointMessage.prototype = $desc;
  function _GarbageCollectionReport(_internal) {
    this._internal = _internal;
  }
  _GarbageCollectionReport.builtin$cls = "_GarbageCollectionReport";
  if (!"name" in _GarbageCollectionReport)
    _GarbageCollectionReport.name = "_GarbageCollectionReport";
  $desc = $collectedClasses._GarbageCollectionReport;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _GarbageCollectionReport.prototype = $desc;
  function _ProxyInvocation(_internal) {
    this._internal = _internal;
  }
  ...
  function _SourceEvent(_internal) {
    this._internal = _internal;
  }
  _SourceEvent.builtin$cls = "_SourceEvent";
  if (!"name" in _SourceEvent)
    _SourceEvent.name = "_SourceEvent";
  $desc = $collectedClasses._SourceEvent;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _SourceEvent.prototype = $desc;
  function _SourceReady(_internal) {
    this._internal = _internal;
  }
  _SourceReady.builtin$cls = "_SourceReady";
  if (!"name" in _SourceReady)
    _SourceReady.name = "_SourceReady";
  $desc = $collectedClasses._SourceReady;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _SourceReady.prototype = $desc;
  ...
  function StopwatchView(_rootContainer, _containerStack, _upperButtonsSizer, _upperButtonsStack, _startButton, _stopButton, _resetButton, _durationSizer, _durationLabel, _resetSizer, _src, eventable$EventDetector$_typeIndexes, eventable$EventDetector$_emitterIndexes) {
    this._rootContainer = _rootContainer;
    this._containerStack = _containerStack;
    this._upperButtonsSizer = _upperButtonsSizer;
    this._upperButtonsStack = _upperButtonsStack;
    this._startButton = _startButton;
    this._stopButton = _stopButton;
    this._resetButton = _resetButton;
    this._durationSizer = _durationSizer;
    this._durationLabel = _durationLabel;
    this._resetSizer = _resetSizer;
    this._src = _src;
    this.eventable$EventDetector$_typeIndexes = eventable$EventDetector$_typeIndexes;
    this.eventable$EventDetector$_emitterIndexes = eventable$EventDetector$_emitterIndexes;
  }
  StopwatchView.builtin$cls = "StopwatchView";
  if (!"name" in StopwatchView)
    StopwatchView.name = "StopwatchView";
  $desc = $collectedClasses.StopwatchView;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StopwatchView.prototype = $desc;
  function StopwatchView__hookUpEvents_closure(this_0) {
    this.this_0 = this_0;
  }
  StopwatchView__hookUpEvents_closure.builtin$cls = "StopwatchView__hookUpEvents_closure";
  if (!"name" in StopwatchView__hookUpEvents_closure)
    StopwatchView__hookUpEvents_closure.name = "StopwatchView__hookUpEvents_closure";
  $desc = $collectedClasses.StopwatchView__hookUpEvents_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StopwatchView__hookUpEvents_closure.prototype = $desc;
  function StopwatchView__hookUpEvents_closure0(this_1) {
    this.this_1 = this_1;
  }
  StopwatchView__hookUpEvents_closure0.builtin$cls = "StopwatchView__hookUpEvents_closure0";
  if (!"name" in StopwatchView__hookUpEvents_closure0)
    StopwatchView__hookUpEvents_closure0.name = "StopwatchView__hookUpEvents_closure0";
  $desc = $collectedClasses.StopwatchView__hookUpEvents_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StopwatchView__hookUpEvents_closure0.prototype = $desc;
  function StopwatchView__hookUpEvents_closure1(this_2) {
    this.this_2 = this_2;
  }
  StopwatchView__hookUpEvents_closure1.builtin$cls = "StopwatchView__hookUpEvents_closure1";
  if (!"name" in StopwatchView__hookUpEvents_closure1)
    StopwatchView__hookUpEvents_closure1.name = "StopwatchView__hookUpEvents_closure1";
  $desc = $collectedClasses.StopwatchView__hookUpEvents_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StopwatchView__hookUpEvents_closure1.prototype = $desc;
  ...
  function UnresolvableNestedReferenceLoopError(transmittable) {
    this.transmittable = transmittable;
  }
  UnresolvableNestedReferenceLoopError.builtin$cls = "UnresolvableNestedReferenceLoopError";
  if (!"name" in UnresolvableNestedReferenceLoopError)
    UnresolvableNestedReferenceLoopError.name = "UnresolvableNestedReferenceLoopError";
  $desc = $collectedClasses.UnresolvableNestedReferenceLoopError;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UnresolvableNestedReferenceLoopError.prototype = $desc;
